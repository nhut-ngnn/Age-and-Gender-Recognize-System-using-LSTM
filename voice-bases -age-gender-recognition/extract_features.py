...
if __name__ == "__main__":
    features = get_audio_features("C:/Users/admin/Documents/AgeDetection/voice-bases-age-gender-classification/DataSet/vi/clips/common_voice_vi_21824030.mp3", extra_features=["delta", "delta2", "pitch"])
